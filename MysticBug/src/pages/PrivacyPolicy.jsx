  ...
  return (
    <div>
      <div className="relative w-full min-h-[400px] sm:min-h-[500px] md:min-h-[600px] overflow-visible">
        ...
        <div className="relative flex justify-center items-center h-full pt-8 sm:pt-12 md:pt-20">
          <img
            src={images.privacyPolicy}
            alt="homepage"
            className="relative z-20 w-full max-w-[350px] md:max-w-[400px] h-auto object-contain"
          />
        </div>
      ...
      <div className="max-w-7xl mx-auto md:-mt-24">
        <h1 className="text-center text-3xl md:text-4xl font-bold text-gray-900">
          <span className="bg-gradient-to-r from-blue-100 px-2 py-2 rounded-md">Privacy Policy</span>
        </h1>
        <p className="text-center mt-4 md:mt-10">
