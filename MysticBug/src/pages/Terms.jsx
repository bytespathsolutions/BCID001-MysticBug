    ...
    <div>
      <div className="relative w-full min-h-[400px] sm:min-h-[500px] md:min-h-[600px] overflow-visible">
        ...
        <div className="relative flex justify-center items-center h-full pt-8 sm:pt-12 md:pt-10">
          <img
            src={images.terms}
            alt="homepage"
            className="relative z-20 w-full max-w-[400px] md:max-w-[500px] h-auto object-contain"
          />
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto md:-mt-24">
        <h1 className="text-center text-3xl md:text-4xl font-bold text-gray-900">
          <span className="bg-gradient-to-r from-purple-100 px-2 py-2 rounded-md">Terms Of Service</span>
        </h1>
        <div className="mt-4 bg-gradient-to-r from-yellow-100 p-4 rounded-md text-black leading-relaxed">
          <p>
        ...
        <div className="md:hidden h-[490px] absolute inset-0 bg-gradient-to-b from-[#008287] to-[#005B5F] -z-10"></div>
      </div>

      <div className="relative min-h-screen flex justify-center">
        {/* Left Stones */}
        <img
          src={images.stones_left}
          alt="stones"
