  ...
  return (
    <div className='relative'>
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center sm:justify-start px-4">
        <div className="max-w-md sm:max-w-3xl w-full space-y-6 mt-48 sm:px-28">
          ...
          <div className="text-start">
            ...
            <p className="text-gray-600 text-lg flex items-center gap-2">
              Trusted Access to Your Health Journey <span className='text-green-700a'> <icons.FaLeaf className='text-green-700' /></span>
            </p>
        ...
        <img src={images.Investor} alt="Investor image" className='hidden sm:block' />
      </div>
