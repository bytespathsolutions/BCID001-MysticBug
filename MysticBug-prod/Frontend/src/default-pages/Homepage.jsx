          ...
          <div className="flex-1">
            <div className="flex gap-2 sm:gap-3 font-semibold font-lato sm:text-sm text-gray-700 mb-3 flex-wrap">
              <span className="flex items-center gap-1">
                Health <default_page_icons.FaLeaf className="text-[#07353D]" size={12} />
              </span>
              <span className="flex items-center gap-1">
                Care <default_page_icons.FaLeaf className="text-[#07353D]" size={12} />
              </span>
              <span className="flex items-center gap-1">
                Peace <default_page_icons.FaLeaf className="text-[#07353D]" size={12} />
              </span>
              <span className="flex items-center gap-1">
                Simplicity <default_page_icons.FaLeaf className="text-[#07353D]" size={12} />
              </span>
            </div>
