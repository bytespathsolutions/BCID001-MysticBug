    ...
    <>
      ...
      <div className="fixed inset-0 z-[150] flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl h-[85vh] flex flex-col">
          {/* Chat Header */}
          <div className="bg-[#1a7f7f] text-white p-4 rounded-t-2xl flex items-center justify-between">
          ...
          <form
            ...
            className="bg-white p-4 border-t border-gray-200 rounded-b-2xl flex items-center gap-3"
          >
            <input
              type="text"
              value={newMessage}
              ...
              className="flex-1 px-4 py-3 border border-gray-300 rounded-full outline-none focus:border-[#1a7f7f] focus:ring-2 focus:ring-[#1a7f7f] focus:ring-opacity-20 transition"
            />
            <button
              type="submit"
              disabled={!newMessage.trim()}
              className="bg-[#1a7f7f] text-white px-6 py-3 rounded-full hover:bg-[#145f5f] disabled:bg-gray-300 disabled:cursor-not-allowed transition flex items-center gap-2"
            >
              <span>Send</span>
